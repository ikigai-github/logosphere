    ...
    switch (sourceSchemaType) {
      case SchemaType.Json:
        switch (targetSchemaType) {
          ...
          case SchemaType.Canonical:
            return new Converter(new JsonSchemaParser(), new CanonicalSchemaGenerator())
          default:
            throw new Error(
      ...
      case SchemaType.Canonical:
        switch (targetSchemaType) {
          ...
          case SchemaType.Fluree:
            return new Converter(new CanonicalSchemaParser(), new FlureeGenerator());
          case SchemaType.Dto:
            return new Converter(new CanonicalSchemaParser(), new DtoGenerator());
          default:
            throw new Error(
              `${sourceSchemaType} to ${targetSchemaType} converter not implemented.`
            );
