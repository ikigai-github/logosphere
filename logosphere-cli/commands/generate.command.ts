...
import { LogosphereCollection } from '../lib/schematics/logosphere.collection';
...
export class GenerateCommand extends AbstractCommand {
  ...
  private buildDescription(): string {
    return (
      'Generate a Logosphere element.\n' +
      `  Schematics available on ${chalk.bold(
        '@logosphere/schematics',
      )} collection:\n` +
  ...
  private buildSchematicsListAsTable(): string {
    ...
    for (const schematic of LogosphereCollection.getSchematics()) {
      table.push([
