...
class WalletAsset {
  ...
  @Prop({ doc: 'Fingerprint of the asset', examples: ['asset12q7zh30hj2yme96wy8ms4fcdrwtep0auz8xqly'] })
  fingerprint: string;

  @Prop({ doc: 'Policy ID of the asset', examples: ['0b7018936bc41808ddabd96b4908b583195a0c252b5752ad38012bdb'] })
  policyId: string;
  ...
  @Prop( {doc: 'Logosphere ID of the asset', examples: ['62c0ac76d6eebbf70828da57ea06c41a55001a2eb3cc929206d8f39abdbfaefc']})
  logosphereId: string;
}
...
class Wallet {
  ...
  @Prop( {
    ...
    index: true,
    unique: true,
    examples: ['addr_test1qzsn8km55mp6cra7l20cymauks2fay8sqc3jr874mgmxpsa5mj4dvw5zrxmhauknj60c8tsf7x72ng0r8zmxa3necjlsgx9q6d']
  })
  address: string;
  ...
  @Prop( {
    ...
    index: true,
    unique: true,
    examples: ['a1f009e6f5770c7b10729f27237c7ccc677739e31119a69766664dee611220948234926b2c445c2e9e2ff40f22beafa193d7fedf72e5e877bffd606d33b6638c']
  })
  publicKey: string;
