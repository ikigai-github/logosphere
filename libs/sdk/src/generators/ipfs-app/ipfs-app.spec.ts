...
import { ipfsApplicationGenerator } from './ipfs-app';
...
describe('application generator', () => {
  ...
  it('should generate files', async () => {
    await ipfsApplicationGenerator(tree, {
      name: appName,
  ...
  describe('--skipFormat', () => {
    it('should format files', async () => {
      ...
      await ipfsApplicationGenerator(tree, { name: appName });
    ...
    it('should not format files when --skipFormat=true', async () => {
      ...
      await ipfsApplicationGenerator(tree, { name: appName, skipFormat: true });
